...
def network_analysis(edgelist, n, save):
    ...
    if save == True:
        ...
        print(f"A new visualization has been created: {viz_plot} \nA new file with centrality measures has been created: {output_path}")
...
if __name__=="__main__":
    ...
    network_analysis(args.edgelist, args.nodes, args.save)
